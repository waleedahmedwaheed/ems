				...
				<div class="grid-row">	
						...
						<button onclick="window.print();" id="bprint"> <img src="img/print.png" alt="Print" /> </button>
							...
							<div class="widget-title">Users</div>
								...
								<?php
								$qryu = "SELECT * from users where status=0";
								mysql_select_db($database_dbconfig, $dbconfig);
								...
								<td><a href="del_users.php?u_id=<?php echo $u_id; ?>" ONCLICK="return_confirm('Are you sure you want to delete?');"><img src="img/delete.png" /></a></td>
