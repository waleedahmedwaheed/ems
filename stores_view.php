			...
			<main class="page-content vc_responsive">
				<div class="grid-row">	
						...
						<button onclick="window.print();" id="bprint"> <img src="img/print.png" alt="Print" /> </button>
							...
							<div class="widget-title">Stores</div>
								...
								<?php
								$qryu = "SELECT * from store where status=0";
								mysql_select_db($database_dbconfig, $dbconfig);
								...
								<td><a href="add_store.php?s_id=<?php echo $s_id; ?>"><img src="img/edit.png" /></td>
								<td><a href="del_store.php?s_id=<?php echo $s_id; ?>" onclick="return_confirm('Are you sure you want to delete?');"><img src="img/delete.png" /></a></td>
